...
<body class="p4">
	...
	<form action="<%=ORSView.PODCAST_LIST_CTL%>" method="post">
		...
		<div class="row">
			...
			<div class="col-sm-3">
            <input type="text" name="podcastTitle" placeholder="Enter podcastTitle"
						class="form-control"
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Podcast Code</th>
						<th class="text">Podcast Title</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getPodcastCode()%></td>
						<td align="center"><%=dto.getPodcastTitle()%></td>
						<td align="center"><%=dto.getHostName()%></td>
						<td align="center"><%=dto.getStatus()%></td>

						<td align="center"><a
							href="PodcastCtl?id=<%=dto.getId()%>">Edit</a></td>
