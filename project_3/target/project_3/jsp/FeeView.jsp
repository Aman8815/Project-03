<%@page import="in.co.rays.project_3.controller.FeeCtl"%>
...
<body class="p4">
	...
	<div>
		<jsp:useBean id="dto" class="in.co.rays.project_3.dto.FeeDTO"
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Fee
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<div class="md-form">
									...
									<span class="pl-sm-5"><b>paymentStatus</b><span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>paymentDate</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text" id="datepicker2"  class="form-control" name="paymentDate"
													placeholder="Enter paymentDate"
													value="<%=DataUtility.getStringData(dto.getPaymentDate())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("paymentDate", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=FeeCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=FeeCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=FeeCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=FeeCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
