<%@page import="in.co.rays.project_3.controller.PressCtl"%>
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Press
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<div class="md-form">
									<span class="pl-sm-5"><b>Author</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("author", request)%></font></br>
									...
									<div class="md-form">
										...
										<div class="col-sm-12">
											<div class="input-group">
												...
												<input type="text" id="datepicker2"  class="form-control" name="releaseDate"
													placeholder="Enter releaseDate"
													value="<%=DataUtility.getStringData(dto.getReleaseDate())%>">
											</div>
										</div>
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=PressCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=PressCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=PressCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=PressCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
