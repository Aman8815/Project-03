				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Meeting
								Room</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Asset Code</b><span
								...
								<div class="md-form">
									...
									<span class="pl-sm-5"><b>Asset Type</b><span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="assetType"
												...
												value="<%=DataUtility.getStringData(dto.getAssetType())%>">
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>Asset Status</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text" class="form-control" name="assetStatus"
													placeholder="Enter assetStatus"
													value="<%=DataUtility.getStringData(dto.getAssetStatus())%>">
											</div>
										</div>
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=MeetingRoomCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=MeetingRoomCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=MeetingRoomCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=MeetingRoomCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
