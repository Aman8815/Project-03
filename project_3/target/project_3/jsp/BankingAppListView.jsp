<%@page import="in.co.rays.project_3.controller.BankingAppListCtl"%>
<%@page import="in.co.rays.project_3.dto.BankingAppDTO"%>
...
<html>
<head>
<title>Banking App List View</title>
...
<body class="p4">
	...
	<form action="<%=ORSView.LOAN_LIST_CTL%>" method="post">
		...
		<jsp:useBean id="dto" class="in.co.rays.project_3.dto.BankingAppDTO"
		...
		<%
			...
			Iterator<BankingAppDTO> it = null;
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Banking App List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
            ...
            <input type="text" name="balance" placeholder="Enter balance"
						class="form-control"
						value="<%=ServletUtility.getParameter("balance", request)%>">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=BankingAppListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=BankingAppListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Account Holder</th>
						<th class="text">Balance</th>
						<th class="text">Branch Name</th>
						<th class="text">IFSCCode</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getAccountHolder()%></td>
						<td align="center"><%=dto.getBalance()%></td>
						<td align="center"><%=dto.getBranchName()%></td>
						<td align="center"><%=dto.getIFSCCode()%></td>

						<td align="center"><a
							href="BankingAppCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=BankingAppListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>
					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=BankingAppListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=BankingAppListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=BankingAppListCtl.OP_NEXT%>"
		...
		<center>
			<h2>BankingApp List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=BankingAppListCtl.OP_BACK%>">
			</div>
		</center>
