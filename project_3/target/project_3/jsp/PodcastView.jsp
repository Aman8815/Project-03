				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Podcast
								</h3>
							<%
								}
							%>
								...
								<div class="md-form">
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("hostName", request)%></font></br>
										...
										<span class="pl-sm-5"><b>Status</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12" style="width='12px'">
											<div class="input-group">
												<div class="input-group-prepend">
													<div class="input-group-text">
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=PodcastCtl.OP_UPDATE%>"> <input
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=PodcastCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
