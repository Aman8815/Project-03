	...
	<form action="<%=ORSView.DOCTER_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Docter List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=DocterListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=DocterListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getDoctorName()%></td>
						<td align="center"><%=dto.getSpecialization()%></td>
						<td align="center"><%=dto.getExperience()%></td>
						<td align="center"><%=dto.getContectNo()%></td>

						<td align="center"><a
							href="DocterCtl?id=<%=dto.getId()%>">Edit</a></td>
