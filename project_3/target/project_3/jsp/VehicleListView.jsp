	...
	<form action="<%=ORSView.VEHICLE_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Vehicle List</font>
			</h1>
		</center>
		<div class="row">
			...
			<table class="table table-dark table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getVehicleName()%></td>
						<td align="center"><%=dto.getModel()%></td>
						<td align="center"><%=dto.getColor()%></td>
						<td align="center"><%=dto.getPrice()%></td>

						<td align="center"><a
							href="VehicleCtl?id=<%=dto.getId()%>">Edit</a></td>
