<%@page import="in.co.rays.project_3.dto.WaterDTO"%>
<%@page import="in.co.rays.project_3.controller.WaterListCtl"%>
...
<body class="p4">
	...
	<form action="<%=ORSView.WATER_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Water List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=WaterListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=WaterListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Water Code</th>
						<th class="text">Location</th>
						<th class="text">Water Level</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getWaterCode()%></td>
						<td align="center"><%=dto.getLocation()%></td>
						<td align="center"><%=dto.getWaterLevel()%></td>
						<td align="center"><%=dto.getStatus()%></td>

						<td align="center"><a
							href="WaterCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=WaterListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>
					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=WaterListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=WaterListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=WaterListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Water List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=WaterListCtl.OP_BACK%>">
			</div>
		</center>
