				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Docter
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Docter Name</b><span
								...
								<div class="md-form">
									<span class="pl-sm-5"><b>Specialization</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
											...
											<input type="text" class="form-control" name="specialization"
												...
												value="<%=DataUtility.getStringData(dto.getSpecialization())%>">
										</div>
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("specialization", request)%></font></br>
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>ContectNo</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text"   class="form-control" name="contectNo"
													placeholder="Enter contectNo"
													value="<%=DataUtility.getStringData(dto.getContectNo())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("contectNo", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=DocterCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=DocterCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=DocterCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=DocterCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
