	...
	<form action="<%=ORSView.VENDOR_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Vendor List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-3">
            <input type="text" name="lenderName" placeholder="Enter address"
						class="form-control"
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=VendorListCtl.OP_SEARCH%>"> <input
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">MobileNO</th>
						<th class="text">Address</th>
						<th class="text">ServiceType</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getServiceType()%></td>

						<td align="center"><a
							href="VendorCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=VendorListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=VendorListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=VendorListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Vendor List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=VendorListCtl.OP_BACK%>">
			</div>
		</center>
