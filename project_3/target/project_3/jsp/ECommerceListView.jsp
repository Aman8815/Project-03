...
<html>
<head>
<title>ECommerce List View</title>
...
<body class="p4">
	...
	<form action="<%=ORSView.ECOMMERCE_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">E Commerce List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=ECommerceListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=ECommerceListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">ProductName</th>
						<th class="text">price</th>
						<th class="text">Quantity</th>
						<th class="text">PaymentStatus</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><a
							href="ECommerceCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<center>
			<h2>ECommerce List Not Found</h2>
