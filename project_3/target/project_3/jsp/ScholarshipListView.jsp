<%@page import="in.co.rays.project_3.controller.ScholarshipListCtl"%>
<%@page import="in.co.rays.project_3.dto.ScholarshipDTO"%>
...
<html>
<head>
<title>Scholarship List View</title>
...
<body class="p4">
	...
	<form action="<%=ORSView.SCHOLARSHIP_LIST_CTL%>" method="post">
		...
		<%
			...
			Iterator<ScholarshipDTO> it = null;
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Scholarship List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=ScholarshipListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=ScholarshipListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Scholarship Name</th>
						<th class="text"> Amount</th>
						<th class="text">Eligibility</th>
						<th class="text">Last Date</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getScholarshipName()%></td>
						<td align="center"><%=dto.getAmount()%></td>
						<td align="center"><%=dto.getEligibility()%></td>
						<td align="center"><%=dto.getLastDate()%></td>

						<td align="center"><a
							href="ScholarshipCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=ScholarshipListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>
					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ScholarshipListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=ScholarshipListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ScholarshipListCtl.OP_NEXT%>"
		...
		<center>
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=ScholarshipListCtl.OP_BACK%>">
			</div>
		</center>
