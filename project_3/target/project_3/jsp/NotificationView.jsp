				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Notification
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Template Code</b><span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="templateCode"
											placeholder="Enter templateCode "
											value="<%=DataUtility.getStringData(dto.getTemplateCode())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("templateCode", request)%></font></br>
								...
								<div class="md-form">
									...
									<span class="pl-sm-5"><b>Content</b><span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="content"
												...
												value="<%=DataUtility.getStringData(dto.getContent())%>">

									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("content", request)%></font></br>
