				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Decoration
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<div class="md-form">
									<span class="pl-sm-5"><b>Theme</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("theme", request)%></font></br>
						...
						<%
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=DecorationCtl.OP_UPDATE%>"> <input
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=DecorationCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
