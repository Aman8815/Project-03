<%@page import="in.co.rays.project_3.controller.ExamListCtl"%>
<%@page import="in.co.rays.project_3.dto.ExamDTO"%>
	...
	<form action="<%=ORSView.EXAM_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Exam List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=ExamListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=ExamListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Exam Name</th>
						<th class="text">Exam Center</th>
						<th class="text">Total Marks</th>
						<th class="text">Passing Marks</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getExamName()%></td>
						<td align="center"><%=dto.getExamCenter()%></td>
						<td align="center"><%=dto.getTotalMarks()%></td>
						<td align="center"><%=dto.getPassingMarks()%></td>

						<td align="center"><a
							href="ExamCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=ExamListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>
					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ExamListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=ExamListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ExamListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Branch List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=ExamListCtl.OP_BACK%>">
			</div>
		</center>
