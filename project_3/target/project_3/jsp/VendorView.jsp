				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Vendor
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Vendor Name</b><span
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("vendorName", request)%></font></br>
								...
								<div class="md-form">
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>Service Type</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
										...
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("serviceType", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=VendorCtl.OP_UPDATE%>"> <input
