		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<%-- 	<li class="nav-item dropdown" style="padding-left: 4px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.CAR_RENTAL_CTL%>"><i
							class="fa fa-user-circle"></i>Add Car</a> <a
							class="dropdown-item" href="<%=ORSView.CAR_RENTAL_LIST_CTL%>"><i
							class="fa fa-user-friends"></i>Car List</a>
					</div></li>
