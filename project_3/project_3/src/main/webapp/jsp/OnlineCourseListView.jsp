...
<body class="p4">
	...
	<form action="<%=ORSView.ONLINE_COURSE_LIST_CTL%>" method="post">
		...
		<%
			...
			Iterator<OnlineCourseDTO> it = null;
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Course List</font>
			</h1>
		</center>
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					...
					value="<%=OnlineCourseListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Course Title</th>
						<th class="text">Duration</th>
						<th class="text">Module Name</th>
						<th class="text">Instructor Name</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getCourse_title()%></td>
						<td align="center"><%=dto.getDuration()%></td>
						<td align="center"><%=dto.getModule_name()%></td>
						<td align="center"><%=dto.getInstructor_name()%></td>

						<td align="center"><a
							href="OnlineCourseCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
				...
				<td><input type="submit" name="operation"
					value="<%=OnlineCourseListCtl.OP_NEW%>"></td>

				<td><input type="submit" name="operation"
					value="<%=OnlineCourseListCtl.OP_DELETE%>"></td>

				<td align="right"><input type="submit" name="operation"
					value="<%=OnlineCourseListCtl.OP_NEXT%>"
