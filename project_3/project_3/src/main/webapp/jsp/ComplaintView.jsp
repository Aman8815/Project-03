				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Complaint
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>complaintCode</b><span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="complaintCode"
											placeholder="Enter complaintCode "
											value="<%=DataUtility.getStringData(dto.getComplaintCode())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("complaintCode", request)%></font></br>
								...
								<div class="md-form">
									...
									<span class="pl-sm-5"><b>complaintType</b><span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="complaintType"
												placeholder="Enter complaintType"
												value="<%=DataUtility.getStringData(dto.getComplaintType())%>">

									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("complaintType", request)%></font></br>



									<div class="md-form">
										<span class="pl-sm-5"><b>complaintStatus</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text" class="form-control" name="complaintStatus"
													placeholder="Enter complaintStatus"
													value="<%=DataUtility.getStringData(dto.getComplaintStatus())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("complaintStatus", request)%></font></br>
										<%
											if (id > 0) {
										%>
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=ComplaintCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
