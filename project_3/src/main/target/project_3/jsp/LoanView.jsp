				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Loan
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>lenderName</b><span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="lenderName"
											placeholder="Enter lenderName "
											value="<%=DataUtility.getStringData(dto.getLenderName())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("lenderName", request)%></font></br>


								<div class="md-form">
									<span class="pl-sm-5"><b>loanAmount</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>maturityDate</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text" id="datepicker2"  class="form-control" name="maturityDate"
													placeholder="Enter maturityDate"
													value="<%=DataUtility.getStringData(dto.getMaturityDate())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("maturityDate", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=LoanCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=LoanCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=LoanCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=LoanCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
