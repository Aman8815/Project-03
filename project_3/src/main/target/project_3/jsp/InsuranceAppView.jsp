<%@page import="in.co.rays.project_3.controller.InsuranceAppCtl"%>
...
<title>Insurance App view</title>
<style type="text/css">
i.css {
...
<body class="p4">
	...
	<div>
		<jsp:useBean id="dto" class="in.co.rays.project_3.dto.InsuranceAppDTO"
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Insurance
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<div class="md-form">
									<span class="pl-sm-5"><b>PolicyType</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
											...
											<input type="text" class="form-control" name="policyType"
												placeholder="Enter policyType"
												value="<%=DataUtility.getStringData(dto.getPolicyType())%>">
										</div>
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("policyType", request)%></font></br>


									<span class="pl-sm-5"><b>PremiumAmount</b><span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="premiumAmount"
												placeholder="Enter premiumAmount"
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>ClaimStatus</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text"  class="form-control" name="claimStatus"
													placeholder="Enter claimStatus"
													value="<%=DataUtility.getStringData(dto.getClaimStatus())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("claimStatus", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=InsuranceAppCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=InsuranceAppCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=InsuranceAppCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=InsuranceAppCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
