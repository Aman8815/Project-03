<%@page import="in.co.rays.project_3.dto.InsuranceAppDTO"%>
<%@page import="in.co.rays.project_3.controller.InsuranceAppListCtl"%>
...
<html>
<head>
<title>InsuranceApp List View</title>
...
<body class="p4">
	...
	<form action="<%=ORSView.INSURANCEAPP_LIST_CTL%>" method="post">
		...
		<%
			...
			Iterator<InsuranceAppDTO> it = null;
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">InsuranceApp List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-3">
            <input type="text" name="claimStatus" placeholder="Enter claimStatus"
						class="form-control"
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					...
					value="<%=InsuranceAppListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Policy Type</th>
						<th class="text">Premium Amount</th>
						<th class="text">Claim Status</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getPolicyType()%></td>
						<td align="center"><%=dto.getPremiumAmount()%></td>
						<td align="center"><%=dto.getClaimStatus()%></td>

						<td align="center"><a
							href="InsuranceAppCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=InsuranceAppListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=InsuranceAppListCtl.OP_DELETE%>"></td>
		...
		<center>
			<h2>Insurance List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=InsuranceAppListCtl.OP_BACK%>">
			</div>
		</center>
