<%@page import="in.co.rays.project_3.controller.BankingAppCtl"%>
...
<body class="p4">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.BANKINGAPP_CTL%>" method="post">
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Banking App
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("branchName", request)%></font></br>


								<div class="md-form">
									<span class="pl-sm-5"><b>Account Holder</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("accountHolder", request)%></font></br>
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>IFSCCode</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text"  class="form-control" name="IFSCCode"
													...
													value="<%=DataUtility.getStringData(dto.getIFSCCode())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("IFSCCode", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=BankingAppCtl.OP_UPDATE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=BankingAppCtl.OP_CANCEL%>">
										</div>
										<%
											} else {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=BankingAppCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=BankingAppCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
