<%@page import="in.co.rays.project_3.controller.SmartListCtl"%>
<%@page import="in.co.rays.project_3.dto.SmartDTO"%>
...
<body class="p4">
	...
	<form action="<%=ORSView.SMART_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Smart Light List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=SmartListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=SmartListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Brightness Level</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getLightCode()%></td>
						<td align="center"><%=dto.getRoomName()%></td>
						<td align="center"><%=dto.getBrightnessLevel()%></td>
						<td align="center"><%=dto.getStatus()%></td>

						<td align="center"><a
							href="SmartCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=SmartListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>
					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=SmartListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=SmartListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=SmartListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Smart Light List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=SmartListCtl.OP_BACK%>">
			</div>
		</center>
