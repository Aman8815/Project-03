<%@page import="in.co.rays.project_3.dto.ReturnDTO"%>
<%@page import="in.co.rays.project_3.controller.ReturnListCtl"%>
...
<body class="p4">
	...
	<form action="<%=ORSView.RETURN_LIST_CTL%>" method="post">

		<jsp:useBean id="dto" class="in.co.rays.project_3.dto.ReturnDTO"
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Return List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=ReturnListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=ReturnListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getReturnCode()%></td>
						<td align="center"><%=dto.getOrderId()%></td>
						<td align="center"><%=dto.getReason()%></td>
						<td align="center"><%=dto.getStatus()%></td>

						<td align="center"><a
							href="ReturnCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=ReturnListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>
					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ReturnListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=ReturnListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ReturnListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Return List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=ReturnListCtl.OP_BACK%>">
			</div>
		</center>
