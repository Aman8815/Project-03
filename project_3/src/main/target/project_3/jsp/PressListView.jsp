<%@page import="in.co.rays.project_3.controller.PressListCtl"%>
<%@page import="in.co.rays.project_3.dto.PressDTO"%>
...
<body class="p4">
	...
	<form action="<%=ORSView.PRESS_LIST_CTL%>" method="post">
		...
		<jsp:useBean id="dto" class="in.co.rays.project_3.dto.PressDTO"
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Press List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=PressListCtl.OP_SEARCH%>"> <input
			...
			<table class="table table-dark table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getReleaseDate()%></td>

						<td align="center"><a
							href="PressCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=PressListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=PressListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=PressListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Press List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=PressListCtl.OP_BACK%>">
			</div>
		</center>
