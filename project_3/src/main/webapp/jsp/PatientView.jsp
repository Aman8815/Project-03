				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Patient
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<div class="md-form">
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>Admission Date</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text" id="datepicker2"  class="form-control" name="admissionDate"
													placeholder="Enter admissionDate"
													value="<%=DataUtility.getStringData(dto.getAdmissionDate())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("admissionDate", request)%></font></br>
										<%
											if (id > 0) {
										%>
