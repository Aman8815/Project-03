				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Vehicle
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("vehicleName", request)%></font></br>
								...
								<div class="md-form">
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("model", request)%></font></br>
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("color", request)%></font></br>
									...
									<div class="md-form">
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=VehicleCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
