...
<html>
<head>
<title>NFT Asset List View</title>
...
<body class="p4">
	...
	<form action="<%=ORSView.NFTASSET_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">NFT Asset List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					...
					value="<%=NFTAssetListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">NFT Code</th>
						<th class="text">Asset Name</th>
						<th class="text">Owner Name</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getNftCode()%></td>
						<td align="center"><%=dto.getAssetName()%></td>
						<td align="center"><%=dto.getOwnerName()%></td>
						<td align="center"><%=dto.getStatus()%></td>

						<td align="center"><a
							href="NFTAssetCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=NFTAssetListCtl.OP_NEXT%>"
		...
		<center>
			<h2>NFT Asset List Not Found</h2>
