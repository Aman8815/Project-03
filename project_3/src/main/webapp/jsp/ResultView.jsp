				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Result
								</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Student ID</b><span
								...
								<div class="md-form">
									<span class="pl-sm-5"><b>Percentage</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
											...
											<input type="text" class="form-control" name="percentage"
												...
												value="<%=DataUtility.getStringData(dto.getPercentage())%>">
										</div>
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("percentage", request)%></font></br>


									<span class="pl-sm-5"><b>Grade</b><span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="grade"
												...
												value="<%=DataUtility.getStringData(dto.getGrade())%>">

									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("grade", request)%></font></br>



									<div class="md-form">
										<span class="pl-sm-5"><b>ResultStatus</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text"  class="form-control" name="resultStatus"
													placeholder="Enter resultStatus"
													value="<%=DataUtility.getStringData(dto.getResultStatus())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("resultStatus", request)%></font></br>
										<%
											if (id > 0) {
										%>
										<div class="text-center">
											...
											<input type="submit" name="operation"
												...
												value="<%=ResultCtl.OP_UPDATE%>"> <input
