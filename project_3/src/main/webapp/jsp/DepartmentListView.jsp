<%@page import="in.co.rays.project_3.controller.DepartmentListCtl"%>
<%@page import="in.co.rays.project_3.dto.DepartmentDTO"%>
...
<body class="p4">
	...
	<form action="<%=ORSView.DEPARTMENT_LIST_CTL%>" method="post">
		...
		<%
			...
			Iterator<DepartmentDTO> it = null;
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Department List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					...
					value="<%=DepartmentListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Hod Name</th>
						<th class="text">Tatal Faculty</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getDepartmentName()%></td>
						<td align="center"><%=dto.getHodName()%></td>
						<td align="center"><%=dto.getTotalFaculty()%></td>
						<td align="center"><%=dto.getLocation()%></td>

						<td align="center"><a
							href="DepartmentCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=DepartmentListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=DepartmentListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Department List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=DepartmentListCtl.OP_BACK%>">
			</div>
		</center>
