	...
	<form action="<%=ORSView.PATIENT_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Patient List</font>
			</h1>
		</center>
		<div class="row">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">PatientName</th>
						<th class="text">Disease</th>
						<th class="text">DoctorName</th>
						<th class="text">AdmissionDate</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getPatientName()%></td>
						<td align="center"><%=dto.getDisease()%></td>
						<td align="center"><%=dto.getDoctorName()%></td>
						<td align="center"><%=dto.getAdmissionDate()%></td>
