	...
	<form action="<%=ORSView.RESULT_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Result List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=ResultListCtl.OP_SEARCH%>"> <input
			...
			<table class="table table-dark table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getPercentage()%></td>
						<td align="center"><%=dto.getGrade()%></td>
						<td align="center"><%=dto.getResultStatus()%></td>

						<td align="center"><a
							href="ResultCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ResultListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Result List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=ResultListCtl.OP_BACK%>">
			</div>
		</center>
