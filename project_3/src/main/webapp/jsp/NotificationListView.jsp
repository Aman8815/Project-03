...
<html>
<head>
<title>Notification List View</title>
...
<body class="p4">
	...
	<form action="<%=ORSView.NOTIFICATION_LIST_CTL%>" method="post">
		...
		<%
			...
			Iterator<NotificationDTO> it = null;
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Notification List</font>
			</h1>
		</center>
		<div class="row">
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Template Code</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getTemplateCode()%></td>
		...
		<center>
			<h2>Notification List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=NotificationListCtl.OP_BACK%>">
			</div>
		</center>
