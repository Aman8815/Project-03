...
<body class="p4">
	...
	<div>
		<jsp:useBean id="dto" class="in.co.rays.project_3.dto.OnlineCourseDTO"
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Online
								Course</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>Course Title</b><span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="course_title"
											...
											value="<%=DataUtility.getStringData(dto.getCourse_title())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("course_title", request)%></font></br>


								<div class="md-form">
									<span class="pl-sm-5"><b>Module Name</b><span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
											...
											<input type="text" class="form-control" name="module_name"
												...
												value="<%=DataUtility.getStringData(dto.getModule_name())%>">
										</div>
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("module_name", request)%></font></br>
									...
									<div class="md-form">
										<span class="pl-sm-5"><b>Instructor Name</b><span
											style="color: red;">*</span></span> </br>
										<div class="col-sm-12">
											<div class="input-group">
												<div class="input-group-prepend">
												...
												<input type="text" class="form-control" name="instructor_name"
													...
													value="<%=DataUtility.getStringData(dto.getInstructor_name())%>">
											</div>
										</div>
										<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("instructor_name", request)%></font></br>
										<%
											if (id > 0) {
										%>
										...
										<div class="text-center">
											...
											<input type="submit" name="operation"
												class="btn btn-success btn-md" style="font-size: 17px"
												value="<%=OnlineCourseCtl.OP_SAVE%>"> <input
												type="submit" name="operation"
												class="btn btn-warning btn-md" style="font-size: 17px"
												value="<%=OnlineCourseCtl.OP_RESET%>">
										</div>
										<%
											}
										%>
