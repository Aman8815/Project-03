<%@page import="in.co.rays.project_3.controller.FeeListCtl"%>
<%@page import="in.co.rays.project_3.dto.FeeDTO"%>
...
<body class="p4">
	...
	<form action="<%=ORSView.FEE_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Fee List</font>
			</h1>
		</center>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<input type="submit" class="btn btn-primary" name="operation"
					value="<%=FeeListCtl.OP_SEARCH%>"> <input
					type="submit" class="btn btn-dark" name="operation"
					value="<%=FeeListCtl.OP_RESET%>">
			...
			<table class="table table-dark table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getStudentId()%></td>
						<td align="center"><%=dto.getAmount()%></td>
						<td align="center"><%=dto.getPaymentStatus()%></td>
						<td align="center"><%=dto.getPaymentDate()%></td>

						<td align="center"><a
							href="FeeCtl?id=<%=dto.getId()%>">Edit</a></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=FeeListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=FeeListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=FeeListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Fee List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=FeeListCtl.OP_BACK%>">
			</div>
		</center>
