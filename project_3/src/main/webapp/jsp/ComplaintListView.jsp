	...
	<form action="<%=ORSView.COMPLAINT_LIST_CTL%>" method="post">
		...
		<center>
			<h1 class="text-light font-weight-bold pt-2">
				<font color="black">Complaint List</font>
			</h1>
		</center>
			...
			<table class="table table-dark table-bordered">
				...
				<thead>
					...
					<tr>
						...
						<th class="text">Complaint Code</th>
						<th class="text">Customer Name</th>
						<th class="text">Complaint Type</th>
						<th class="text">Complaint Status</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><%=dto.getComplaintCode()%></td>
						<td align="center"><%=dto.getCustomerName()%></td>
						<td align="center"><%=dto.getComplaintType()%></td>
						<td align="center"><%=dto.getComplaintStatus()%></td>
		...
		<table width="100%">
			...
			<tr>
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ComplaintListCtl.OP_NEXT%>"
		...
		<center>
			<h2>Complaint List Not Found</h2>
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=ComplaintListCtl.OP_BACK%>">
			</div>
		</center>
