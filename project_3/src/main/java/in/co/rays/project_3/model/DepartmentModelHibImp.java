...
public class DepartmentModelHibImp implements DepartmentModelInt  {
	...
	public long add(DepartmentDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		Transaction tx = null;
		long pk = 0;
		DepartmentDTO existDto = findByName(dto.getDepartmentName());
		if (existDto != null) {
			throw new DuplicateRecordException("DepartmentName already exist");
		}
		try {
	...
	public DepartmentDTO findByName(String name) throws ApplicationException {
		// TODO Auto-generated method stub
		Session session = null;
		DepartmentDTO dto = null;
		try {
		...
		// TODO Auto-generated method stub
		  Session session = null;
	        ...
	        try {
	            ...
	            if (dto.getTotalFaculty()!= null && dto.getTotalFaculty() > 0) {
	                criteria.add(Restrictions.eq("totalFaculty", dto.getTotalFaculty()
	                    ));
	            }
