			...
			try {
				if (id > 0) {
					...
					try {
						...
						ServletUtility.setDto(dto, request);
						ServletUtility.setErrorMessage("Schedule Code  already exists", request);
					}
				}
				...
				ServletUtility.setDto(dto, request);
				ServletUtility.setErrorMessage("ScheduleCode already exists", request);
			}
