...
public class NotificationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		boolean pass = true;
		if (DataValidator.isNull(request.getParameter("templateCode"))) {
			request.setAttribute("templateCode", PropertyReader.getValue("error.require", "templateCode"));
			pass = false;
		}
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		dto.setTemplateCode(DataUtility.getString(request.getParameter("templateCode")));
		dto.setTitle(DataUtility.getString(request.getParameter("title")));
		dto.setContent(DataUtility.getString(request.getParameter("content")));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SAVE.equalsIgnoreCase(op) || OP_UPDATE.equalsIgnoreCase(op)) {
			...
			try {
				...
				ServletUtility.setDto(dto, request);
				ServletUtility.setErrorMessage("Template Code Exiest", request);
			}
